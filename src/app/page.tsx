...
export default function Home() {
    ...
    useEffect(() => {
        const onScroll = () => {
            // si la ventana ha hecho scroll > 0, activamos el fondo
        ...
        <div className="flex flex-col">
            ...
            >
                <div className="container mx-auto flex h-16 items-center justify-between px-4">
                    {/* Mantiene la altura en 2rem (h-8) y ajusta el ancho automáticamente */}
                    <Image
                        src={logo}
                        alt="Kipo"
            ...
            {/* Features - Espaciado mejorado, diseño limpio */}
            <section
                id="features"
            ...
            {/* Lo que viene - Diseño minimalista tipo Notion */}
            <section id="future" className="py-24 container mx-auto">
                <div className="space-y-16 px-4">
                    <div className="text-center space-y-6">
                        ...
                        <p className="text-muted-foreground max-w-xl mx-auto">
                            Seguimos innovando: estas son algunas de las
                            integraciones y mejoras que están en camino.
                        </p>
                    </div>
                    ...
                    <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-6">
                        {[
                            {
                                icon: Zap,
                                title: "Reconocimiento de recibos OCR",
                            },
                            { icon: Gift, title: "Reward points integrados" },
                            {
                                icon: BadgeCheck,
                                title: "Certificados de metas cumplidas",
                            },
                            {
                                icon: ArrowRight,
                                title: "Integración con NFT financieras",
                            },
                        ].map(({ icon: Icon, title }) => (
                            <div
                                key={title}
                                className="p-6 bg-white rounded-lg border border-primary/20 hover:border-primary/40 transition-colors"
                            >
            ...
            <footer className="py-16 bg-background pb-6">
                <div className="container mx-auto grid md:grid-cols-4 gap-12 text-sm px-4">
                    <div className="text-center ">
                        <h4 className="font-medium mb-4 text-xs uppercase tracking-wider text-primary">
                            Kipo
                        </h4>
